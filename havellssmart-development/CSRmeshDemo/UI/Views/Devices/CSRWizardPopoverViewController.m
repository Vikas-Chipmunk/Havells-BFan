...
#warning If we pass a invalid short code the below method is going bonkers...
    ...
    //    [devEntity setDeviceId:[[CSRDatabaseManager sharedInstance] getNextFreeDeviceNumber]];
...
- (void)deviceAssociationSuccess:(NSNotification *)notification
{
    ...
    [appDelegate.window makeToast:@"Device Associated Successfully." duration:3 position:CSToastPositionTop];
