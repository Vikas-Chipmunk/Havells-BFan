...
- (void)viewDidLoad
{
    ...
    _menuTier1Array = @[@{@"icon":[CSRmeshStyleKit imageOfFavouritesIcon], @"name":@"Favourites", @"segueID":@"favouritesSegue"},
                       ...
                       @{@"icon":[CSRmeshStyleKit imageOfBulbIcon], @"name":@"CSRmesh devices", @"segueID":@"devicesSegue"},@{@"icon":[CSRmeshStyleKit imageOfBulbIcon], @"name":@"Places", @"segueID":@"placesSegue"}];*/
    
    _menuTier1Array = @[@{@"icon":[UIImage imageNamed:@"homeicon.png"], @"name":@"Home", @"segueID":@"placesSegue"},@{@"icon":[UIImage imageNamed:@"searchicon.png"], @"name":@"Search new devices", @"segueID":@"devicesSegue"},@{@"icon":[UIImage imageNamed:@"Icn_rules"], @"name":@"My rules", @"segueID":@"myrulesegue"},@{@"icon":[UIImage imageNamed:@"Icn_rules"], @"name":@"Home Gateway", @"segueID":@"GateWaySegue"}];
    
    
    
    
    _menuTier2Array = [NSArray new];/*@[@{@"icon":[CSRmeshStyleKit imageOfUsersIcon], @"name":@"Users", @"segueID":@"usersSegue"},
